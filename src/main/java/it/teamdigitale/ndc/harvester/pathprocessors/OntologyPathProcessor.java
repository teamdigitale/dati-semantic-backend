...
@Component
@Slf4j
public class OntologyPathProcessor extends SemanticAssetPathProcessor<SemanticAssetPath> {

    public OntologyPathProcessor(SemanticAssetModelFactory modelFactory) {
        super(modelFactory);
    }
